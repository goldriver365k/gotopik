...
const READING: ReadingQuestionData[] = [
  {
    ...
    options: ["크고 더러워요", "작고 깨끗해요", "넓고 더러워요", "작고 더러워요"],
    correctAnswer: 1,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S4-P01", type: "vocabulary", question: '"거실"의 뜻은 무엇입니까?', options: ["Living room", "Kitchen", "Bedroom", "Bathroom"], correctAnswer: 0, explanation: { en: "거실 means living room." } },
  { id: "L2-S4-P02", type: "vocabulary", question: '"정리하다"의 뜻은 무엇입니까?', options: ["To clean", "To organize", "To move", "To build"], correctAnswer: 1, explanation: { en: "정리하다 means to organize." } },
  ...
  { id: "L2-S4-P05", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n제 방은 ______.", options: ["좁아요", "넓어요", "깨끗해요", "더러워요"], correctAnswer: 0, explanation: { en: "좁아요 means small/narrow." } },
  ...
  { id: "L2-S4-P09", type: "reading", passage: "제 방에는 침대와 책상이 있어요.", question: "방에 무엇이 있습니까?", options: ["침대와 책상", "냉장고", "의자만", "창문만"], correctAnswer: 0, explanation: { en: 'The passage says there is a bed and a desk, so the answer is 침대와 책상.' } },
