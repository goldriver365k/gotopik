...
const READING: ReadingQuestionData[] = [
  ...
  },
  {
    ...
    options: ["환불했어요", "교환했어요", "할인받았어요", "다시 샀어요"],
    correctAnswer: 1,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S7-P01", type: "vocabulary", question: '"할인"의 뜻은 무엇입니까?', options: ["Discount", "Receipt", "Exchange", "Refund"], correctAnswer: 0, explanation: { en: "할인 means discount." } },
  ...
  { id: "L2-S7-P05", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n이 신발은 ______.", options: ["작아요", "커요", "맞아요", "같아요"], correctAnswer: 0, explanation: { en: "작아요 means small." } },
