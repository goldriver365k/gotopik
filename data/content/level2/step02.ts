...
const LISTENING: ListeningQuestionData[] = [
  ...
  },
  {
    ...
    options: ["영화를 볼 거예요", "축구를 할 거예요", "수영할 거예요", "산책할 거예요"],
    correctAnswer: 1,
...
const READING: ReadingQuestionData[] = [
  ...
  },
  {
    ...
    options: ["가족과 운동", "친구와 영화", "혼자 독서", "동료와 게임"],
    correctAnswer: 1,
...
const PRACTICE: PracticeQuestionData[] = [
  ...
  { id: "L2-S2-P02", type: "vocabulary", question: '"재미있다"의 뜻은 무엇입니까?', options: ["Boring", "Difficult", "Fun", "Easy"], correctAnswer: 2, explanation: { en: "재미있다 means fun/interesting." } },
  { id: "L2-S2-P03", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n주말에 영화를 ______.", options: ["봐요", "봤어요", "볼 거예요", "보고 있어요"], correctAnswer: 2, explanation: { en: "-(으)ㄹ 거예요 marks a future plan: 볼 거예요." } },
  { id: "L2-S2-P04", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n저는 수영을 ______.", options: ["배워요", "배웠어요", "배우세요", "배울 거예요"], correctAnswer: 3, explanation: { en: "-(으)ㄹ 거예요 marks a future plan: 배울 거예요." } },
  { id: "L2-S2-P05", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n저는 영화를 ______ 봐요.", options: ["자주", "가끔", "아직", "벌써"], correctAnswer: 0, explanation: { en: "자주 means often." } },
  ...
  { id: "L2-S2-P07", type: "vocabulary", question: "친구와 함께 무엇을 하고 싶은지 물을 때 자연스러운 대답은?", options: ["같이 게임해요", "혼자 있어요", "학교에 가요", "일해요"], correctAnswer: 0, explanation: { en: "같이 게임해요 fits doing something together with a friend." } },
  { id: "L2-S2-P08", type: "listening", audioText: "저는 주말마다 산책을 해요.", question: "이 사람은 언제 산책을 합니까?", options: ["평일마다", "주말마다", "아침마다", "저녁마다"], correctAnswer: 1, explanation: { en: 'The sentence says "every weekend," so the correct answer is 주말마다.' } },
