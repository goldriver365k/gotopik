...
const READING: ReadingQuestionData[] = [
  ...
  },
  {
    ...
    options: ["친구와 영화", "가족과 운동", "혼자 독서", "동료와 게임"],
    correctAnswer: 0,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S2-P01", type: "vocabulary", question: '"취미"의 뜻은 무엇입니까?', options: ["Study", "Work", "Hobby", "Rest"], correctAnswer: 2, explanation: { en: "취미 means hobby." } },
  ...
  { id: "L2-S2-P05", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n저는 영화를 ______ 봐요.", options: ["아직", "가끔", "자주", "벌써"], correctAnswer: 2, explanation: { en: "자주 means often." } },
  { id: "L2-S2-P06", type: "sentence", question: "취미가 무엇이냐고 물을 때 대답으로 알맞은 것은?", options: ["네, 맞아요", "감사합니다", "안녕하세요", "제 취미는 여행이에요"], correctAnswer: 3, explanation: { en: "제 취미는 여행이에요 answers 'what is your hobby?'." } },
