...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S1-P01", type: "vocabulary", question: '"하루"의 뜻은 무엇입니까?', options: ["Month", "Week", "Day", "Year"], correctAnswer: 2, explanation: { en: "하루 means a day." } },
  ...
  { id: "L2-S1-P04", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n저는 어제 학교에 ______.", options: ["늦어요", "늦고 있어요", "늦을 거예요", "늦었어요"], correctAnswer: 3, explanation: { en: "-았/었어요 marks the past tense: 늦었어요." } },
  ...
  { id: "L2-S1-P06", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n저는 보통 아홉 시에 ______.", options: ["잘 거예요", "잤어요", "자요", "자고 있어요"], correctAnswer: 2, explanation: { en: "보통 describes a usual, present-tense habit: 아홉 시에 자요." } },
