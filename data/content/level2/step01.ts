...
const READING: ReadingQuestionData[] = [
  ...
  },
  {
    ...
    options: ["아침에 운동하기", "아침에 청소하기", "아침에 요리하기", "아침에 공부하기"],
    correctAnswer: 0,
...
const PRACTICE: PracticeQuestionData[] = [
  ...
  { id: "L2-S1-P02", type: "vocabulary", question: '"습관"의 뜻은 무엇입니까?', options: ["Habit", "Schedule", "Plan", "Rule"], correctAnswer: 0, explanation: { en: "습관 means habit." } },
  ...
  { id: "L2-S1-P05", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n저는 지금 청소______.", options: ["하고 있어요", "할 거예요", "했어요", "하세요"], correctAnswer: 0, explanation: { en: "-고 있다 marks an action in progress: 청소하고 있어요." } },
  { id: "L2-S1-P06", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n저는 보통 아홉 시에 ______.", options: ["잘 거예요", "자요", "잤어요", "자고 있어요"], correctAnswer: 1, explanation: { en: "보통 describes a usual, present-tense habit: 아홉 시에 자요." } },
  { id: "L2-S1-P07", type: "sentence", question: '"아직 준비를 안 했어요"의 뜻은 무엇입니까?', options: ["Preparing now", "Already prepared", "Not prepared yet", "Will prepare"], correctAnswer: 2, explanation: { en: "아직 ... 안 했어요 means 'haven't done (something) yet'." } },
  ...
  { id: "L2-S1-P09", type: "reading", passage: "저는 매일 아침에 씻고 준비해요.", question: "이 사람은 아침에 무엇을 합니까?", options: ["청소해요", "요리해요", "운동해요", "씻고 준비해요"], correctAnswer: 3, explanation: { en: 'The passage says "I wash and get ready," so the correct answer is 씻고 준비해요.' } },
