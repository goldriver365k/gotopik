...
const LISTENING: ListeningQuestionData[] = [
  {
    ...
    options: ["가족하고 여행을 갈 거예요", "집을 청소할 거예요", "회의를 할 거예요", "숙소를 예약할 거예요"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["더 비싸요", "교환할 수 없어요", "더 싸고 할인도 받을 수 있어요", "할인이 없어요"],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ["여행을 갈 거예요", "축제에 참가할 거예요", "숙소를 예약할 거예요", "과제를 제출할 거예요"],
    correctAnswer: 3,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S14-P01", type: "vocabulary", question: '"습관"의 뜻은 무엇입니까?', options: ["Meeting", "Habit", "Discount", "Deadline"], correctAnswer: 1, explanation: { en: "습관 means habit." } },
  ...
  { id: "L2-S14-P03", type: "vocabulary", question: '"마감"의 뜻은 무엇입니까?', options: ["Discount", "Ingredient", "Change", "Deadline"], correctAnswer: 3, explanation: { en: "마감 means deadline." } },
  ...
  { id: "L2-S14-P05", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n이 가방이 저 가방______ 싸요.", options: ["부터", "보다", "동안", "때문에"], correctAnswer: 1, explanation: { en: "-보다 marks comparison: 저 가방보다." } },
  ...
  { id: "L2-S14-P07", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n건강을 위해서 매일 ______.", options: ["운동하지 마세요", "운동해야 해요", "운동했어요", "운동할 수 없어요"], correctAnswer: 1, explanation: { en: "-아/어야 하다 shows necessity: 운동해야 해요." } },
  { id: "L2-S14-P08", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n지하철에서 내린 ______ 버스로 갈아타세요.", options: ["보다", "동안에", "때문에", "후에"], correctAnswer: 3, explanation: { en: "-(으)ㄴ 후에 means \"after\": 내린 후에." } },
  { id: "L2-S14-P09", type: "sentence", question: "친구 생일에 어울리는 표현은?", options: ["생일을 접수해요", "생일을 청소해요", "생일을 교환해요", "생일을 축하해요"], correctAnswer: 3, explanation: { en: "생일을 축하해요 (\"happy birthday\") fits a birthday situation." } },
