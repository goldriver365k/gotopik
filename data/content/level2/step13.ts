...
const LISTENING: ListeningQuestionData[] = [
  ...
  },
  {
    ...
    options: ["이번 주 월요일", "다음 달", "다음 주 월요일", "이번 주 금요일"],
    correctAnswer: 3,
...
const READING: ReadingQuestionData[] = [
  {
    ...
    options: ["이 층 회의실", "일 층 회의실", "사무실", "식당"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["이번 주 월요일", "다음 달", "이번 주 금요일", "다음 주 월요일"],
    correctAnswer: 3,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S13-P01", type: "vocabulary", question: '"공지"의 뜻은 무엇입니까?', options: ["Meeting", "Gift", "Document", "Notice"], correctAnswer: 3, explanation: { en: "공지 means notice." } },
  { id: "L2-S13-P02", type: "vocabulary", question: '"마감"의 뜻은 무엇입니까?', options: ["Start", "Change", "Deadline", "Place"], correctAnswer: 2, explanation: { en: "마감 means deadline." } },
  { id: "L2-S13-P03", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n비 ______ 행사가 취소됐어요.", options: ["부터", "동안", "때문에", "보다"], correctAnswer: 2, explanation: { en: "때문에 means \"because of\": 비 때문에." } },
  { id: "L2-S13-P04", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n이용 시간은 아홉 시 ______ 여섯 시까지예요.", options: ["동안", "때문에", "부터", "보다"], correctAnswer: 2, explanation: { en: "부터 ~ 까지 marks a range: 아홉 시부터 여섯 시까지." } },
  ...
  { id: "L2-S13-P06", type: "vocabulary", question: "돈을 안 내도 될 때 쓰는 말은?", options: ["유료", "금지", "휴무", "무료"], correctAnswer: 3, explanation: { en: "무료 means free (no charge)." } },
  ...
  { id: "L2-S13-P08", type: "listening", audioText: "신청 마감은 이번 주 금요일까지예요.", question: "신청 마감은 언제입니까?", options: ["이번 주 월요일", "다음 달", "다음 주", "이번 주 금요일"], correctAnswer: 3, explanation: { en: 'The sentence says this Friday, so the answer is 이번 주 금요일.' } },
  { id: "L2-S13-P09", type: "reading", passage: "공지: 이번 주는 공사 때문에 이용이 불가능합니다.", question: "왜 이용할 수 없습니까?", options: ["휴무라서", "요금 때문에", "마감이라서", "공사 때문에"], correctAnswer: 3, explanation: { en: 'The notice says because of construction, so the answer is 공사 때문에.' } },
