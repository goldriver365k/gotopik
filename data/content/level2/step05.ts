...
const READING: ReadingQuestionData[] = [
  {
    ...
    options: ["은행 맞은편", "역 근처", "학교 안", "사거리 옆"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["직진해요", "오른쪽으로 가요", "왼쪽으로 가요", "다시 타요"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ["버스만 타요", "걸어가요", "택시를 타요", "지하철을 갈아타요"],
    correctAnswer: 3,
...
const PRACTICE: PracticeQuestionData[] = [
  ...
  { id: "L2-S5-P02", type: "vocabulary", question: '"근처"의 뜻은 무엇입니까?', options: ["Far", "Straight", "Across", "Nearby"], correctAnswer: 3, explanation: { en: "근처 means nearby." } },
  ...
  { id: "L2-S5-P04", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n사거리에서 오른쪽으로 ______.", options: ["도세요", "돌았어요", "돌 거예요", "돌아요"], correctAnswer: 0, explanation: { en: "-(으)세요 makes a polite request: 도세요." } },
