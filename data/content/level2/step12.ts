...
const LISTENING: ListeningQuestionData[] = [
  {
    ...
    options: ["축제 참가", "공연 준비", "선물 구매", "파티 준비"],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ["여행을 갔어요", "혼자 쉬었어요", "친구들을 초대해서 파티를 했어요", "일을 했어요"],
    correctAnswer: 2,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S12-P01", type: "vocabulary", question: '"축제"의 뜻은 무엇입니까?', options: ["Meeting", "Schedule", "Document", "Festival"], correctAnswer: 3, explanation: { en: "축제 means festival." } },
  { id: "L2-S12-P02", type: "vocabulary", question: '"경험"의 뜻은 무엇입니까?', options: ["Culture", "Tradition", "Experience", "Performance"], correctAnswer: 2, explanation: { en: "경험 means experience." } },
  { id: "L2-S12-P03", type: "vocabulary", question: "생일이나 기념일에 주는 것은?", options: ["번호표", "선물", "서류", "일정"], correctAnswer: 1, explanation: { en: "선물 means gift." } },
  { id: "L2-S12-P04", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n한국 음식을 ______.", options: ["먹지 마세요", "먹고 있어요", "먹을 거예요", "먹어 봤어요"], correctAnswer: 3, explanation: { en: "-아/어 보다 means to have tried: 먹어 봤어요." } },
  { id: "L2-S12-P05", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n생일 ______ 친구를 초대했어요.", options: ["때문에", "동안", "후에", "때"], correctAnswer: 3, explanation: { en: "때 means \"at the time of\": 생일 때." } },
  { id: "L2-S12-P06", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n이 축제에 ______.", options: ["참가할 수 없어요", "참가하지 마세요", "참가해 봤어요", "참가해야 해요"], correctAnswer: 2, explanation: { en: "-아/어 보다 describes a tried experience: 참가해 봤어요." } },
