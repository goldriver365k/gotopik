...
const READING: ReadingQuestionData[] = [
  {
    ...
    options: ["운동해요", "같이 점심을 먹어요", "여행해요", "공부해요"],
    correctAnswer: 1,
  ...
  },
  {
    ...
    passage: "오늘은 제 생일이에요.\n친구들을 모임에 초대했어요.",
    question: "오늘 무슨 날입니까?",
    options: ["친구 생일", "제 생일", "회사 모임", "동료 생일"],
    correctAnswer: 1,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S3-P01", type: "vocabulary", question: '"동료"의 뜻은 무엇입니까?', options: ["Coworker", "Neighbor", "Teacher", "Family"], correctAnswer: 0, explanation: { en: "동료 means coworker." } },
  { id: "L2-S3-P02", type: "vocabulary", question: '"친하다"의 뜻은 무엇입니까?', options: ["Busy", "Close/friendly", "Far", "Strange"], correctAnswer: 1, explanation: { en: "친하다 means to be close with someone." } },
  ...
  { id: "L2-S3-P05", type: "sentence", question: "빈칸에 알맞은 것을 고르세요.\n오늘은 제 ______이에요.", options: ["생일", "모임", "약속", "동료"], correctAnswer: 0, explanation: { en: "생일 means birthday." } },
  { id: "L2-S3-P06", type: "sentence", question: "오랜만에 친구를 만났을 때 할 수 있는 말은?", options: ["안녕히 가세요", "오랜만이에요!", "죄송합니다", "괜찮아요"], correctAnswer: 1, explanation: { en: "오랜만이에요! is used when seeing someone after a long time." } },
  ...
  { id: "L2-S3-P09", type: "reading", passage: "저는 친구를 생일 파티에 초대했어요.", question: "저는 무엇을 했습니까?", options: ["초대했어요", "연락했어요", "기다렸어요", "이야기했어요"], correctAnswer: 0, explanation: { en: 'The passage says "I invited," so the correct answer is 초대했어요.' } },
  { id: "L2-S3-P10", type: "reading", passage: "저는 회사 동료와 친해요.", question: "저는 동료와 어떤 사이입니까?", options: ["안 친해요", "친해요", "몰라요", "바빠요"], correctAnswer: 1, explanation: { en: 'The passage says "I am close with my coworker," so the answer is 친해요.' } },
];
