...
const PRACTICE: PracticeQuestionData[] = [
  ...
  { id: "L2-S3-P03", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n비가 ______ 집에 있었어요.", options: ["와서", "오지만", "오고", "오려고"], correctAnswer: 0, explanation: { en: "-아서/어서 gives a reason: 비가 와서 집에 있었어요." } },
  { id: "L2-S3-P04", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n친구를 만나서 같이 밥을 ______.", options: ["먹어요", "먹었어요", "먹고 있어요", "먹을 거예요"], correctAnswer: 1, explanation: { en: "-았/었어요 marks the past tense: 먹었어요." } },
