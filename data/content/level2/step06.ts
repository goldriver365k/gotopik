...
const LISTENING: ListeningQuestionData[] = [
  ...
  },
  {
    ...
    options: ["학교에 가려고", "회사에 가려고", "공항에 가려고", "집에 가려고"],
    correctAnswer: 2,
...
const PRACTICE: PracticeQuestionData[] = [
  ...
  { id: "L2-S6-P09", type: "reading", passage: "비행기는 아홉 시에 출발해요.", question: "비행기는 언제 출발합니까?", options: ["일곱 시", "여덟 시", "열 시", "아홉 시"], correctAnswer: 3, explanation: { en: 'The passage says "at nine o\'clock," so the answer is 아홉 시.' } },
