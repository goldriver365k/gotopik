...
const READING: ReadingQuestionData[] = [
  ...
  },
  {
    ...
    options: ["발표 자료 준비", "과제 제출", "회의 참석", "퇴근"],
    correctAnswer: 0,
...
const PRACTICE: PracticeQuestionData[] = [
  { id: "L2-S10-P01", type: "vocabulary", question: '"회의"의 뜻은 무엇입니까?', options: ["Class", "Meeting", "Assignment", "Schedule"], correctAnswer: 1, explanation: { en: "회의 means meeting." } },
  { id: "L2-S10-P02", type: "vocabulary", question: '"제출하다"의 뜻은 무엇입니까?', options: ["To submit", "To confirm", "To start", "To end"], correctAnswer: 0, explanation: { en: "제출하다 means to submit." } },
  ...
  { id: "L2-S10-P05", type: "grammar", question: "빈칸에 알맞은 것을 고르세요.\n회의 ______ 자료를 확인해요.", options: ["동안", "후에", "때문에", "보다"], correctAnswer: 0, explanation: { en: "동안 means \"during\": 회의 동안." } },
